...
export default function Valid() {
    ...
    const submit = async (ev) => {
      ...
      if(isNaN(parseInt(formValue.age)) || parseInt(formValue.age) < 18){
    ...
    return (
      <div className="App">
        ...
        <Input label='Age' size='medium' error={error.age} placeholder='Age' onchange={(ev) => setFormValue({...formValue, age: ev.currentTarget.value})}></Input>
        <Checkbox type='radio' onchange={handleCheckbox} name='rule' value='yes'/>
        <Checkbox type='radio' onchange={handleCheckbox} name='rule' value='no'/>
